...
export async function seedDatabase() {
  ...
  for (let i = 0; i < 36; i++) {
    ...
    const monthlyReturn = monthlyReturns[i];
    const benchMonthlyReturn = benchMonthlyReturns[i];
    
    portfolioValue *= (1 + monthlyReturn);
    benchmarkValue *= (1 + benchMonthlyReturn);
    ...
    performanceData.push({
      ...
      dailyReturn: monthlyReturn.toFixed(6),

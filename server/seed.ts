...
export async function seedIntervalFunds() {
  ...
  const funds = [
    // --- Real Estate ---
    {
      ...
      description: "Non-traded REIT / interval fund investing in stabilized, income-generating commercial real estate across the U.S., including multifamily, industrial, and net lease properties",
    ...
    },
    {
      ...
      ticker: "SREIT",
      fundManager: "Starwood Capital Group",
      description: "Non-traded REIT interval fund focused on multifamily, industrial, and hospitality real estate with an emphasis on high-growth Sun Belt markets",
      assetClass: "Real Estate",
    ...
    },
    {
      ...
      ticker: "NURE",
      fundManager: "Nuveen (TIAA)",
      description: "Interval fund investing in institutional-quality real estate across global gateway cities including office, retail, and mixed-use properties",
      assetClass: "Real Estate",
    ...
    // --- Private Credit ---
    {
      ...
      ticker: "BCRED",
      fundManager: "Blackstone",
      description: "Private credit interval fund focused on senior secured floating rate loans to large U.S. companies, emphasizing first-lien positions with downside protection",
    ...
    },
    {
      ...
      description: "Direct lending interval fund focused on U.S. upper-middle-market corporate loans, predominantly first-lien senior secured positions",
      assetClass: "Private Credit",
    ...
    },
    {
      ...
      ticker: "KCOF",
      fundManager: "KKR",
      description: "Opportunistic credit interval fund targeting dislocated and special-situation credit across leveraged loans, high yield bonds, and structured products",
      assetClass: "Private Credit",
    ...
    },
    {
      ...
      description: "Multi-strategy private credit interval fund combining direct lending, CLO equity, and distressed debt with a focus on middle-market companies",
      assetClass: "Private Credit",
    ...
    // --- Infrastructure ---
    {
      ...
      description: "Infrastructure interval fund investing in essential-service assets including utilities, transportation, midstream energy, and data infrastructure globally",
      assetClass: "Infrastructure",
      strategyType: "Core Infrastructure",
      repurchaseFrequency: "Quarterly",
      repurchaseRate: "0.05",
      repurchaseNotice: 30,
      fundStructure: "Interval Fund",
    ...
    // --- Private Equity ---
    {
      ...
      ticker: "APMF",
      fundManager: "Ares Management",
      description: "Private equity secondaries and co-investment interval fund providing access to diversified private equity exposure with enhanced liquidity features",
      assetClass: "Private Equity",
      strategyType: "PE Secondaries & Co-Invest",
      repurchaseFrequency: "Quarterly",
      repurchaseRate: "0.05",
      repurchaseNotice: 65,
      fundStructure: "Interval Fund",
    ...
    // --- Multi-Asset ---
    {
      ...
      description: "Multi-asset interval fund blending real estate debt, infrastructure, and asset-backed lending for diversified real asset income and appreciation",
    ...
    // --- Fixed Income ---
    {
      ...
      ticker: "PFLEX",
      fundManager: "PIMCO",
      description: "Multi-sector fixed income interval fund investing in corporate bonds, leveraged loans, structured credit, and emerging market debt with active duration management",
      assetClass: "Fixed Income",
    ...
    // --- Hedge Fund ---
    {
      ...
      ticker: "MAHL",
      fundManager: "Man Group (AHL)",
      description: "Systematic trend-following and alternative risk premia interval fund using quantitative strategies across global futures, equities, and FX markets",
      assetClass: "Hedge Fund",
      strategyType: "Managed Futures / CTA",
      repurchaseFrequency: "Quarterly",
      repurchaseRate: "0.25",
      repurchaseNotice: 45,
      fundStructure: "Interval Fund",
  ...
  console.log("Interval funds seeded successfully (12 funds across 6 asset classes)");
}
